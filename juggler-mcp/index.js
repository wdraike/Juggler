...
server.tool(
  ...
  'Create a single task.',
  {
    ...
    url: z.string().optional().describe('URL associated with the task (e.g. a link to a doc, ticket, or reference page)'),
...
server.tool(
  ...
  'Create multiple tasks at once.',
  {
    tasks: z.array(z.object({
      ...
      tools: z.array(z.string()).optional(),
      notes: z.string().optional(),
      url: z.string().optional().describe('URL associated with the task'),
      habit: z.boolean().optional(),
      rigid: z.boolean().optional(),
      split: z.boolean().optional(),
      splitMin: z.number().optional(),
...
server.tool(
  ...
  'Update fields on an existing task.',
  {
    ...
    tools: z.array(z.string()).optional(),
    notes: z.string().optional(),
    url: z.string().optional().describe('URL associated with the task (pass empty string to clear)'),
    habit: z.boolean().optional(),
    rigid: z.boolean().optional(),
    split: z.boolean().optional(),
    splitMin: z.number().optional(),
