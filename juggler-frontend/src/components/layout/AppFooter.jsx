  ...
  return (
    <div style={{
      ...
      <span style={{ display: 'inline-flex', alignItems: 'baseline', gap: '0.1em' }}>
        ...
        <span style={{ fontFamily: "'EB Garamond', serif", fontStyle: 'italic', fontWeight: 300, color: BRAND.gold, fontSize: 13 }}>&amp;</span>
      ...
      <span style={{ fontFamily: "'EB Garamond', serif", fontStyle: 'italic', fontSize: 12, opacity: 0.6 }}>Old school hustle. New school AI.</span>
      <span style={{ color: theme.borderLight }}>&middot;</span>
