/**
 * Google Calendar adapter — BACK-COMPAT RE-EXPORT SHIM (Wave 5 / W5).
 *
 ...
 *   src/slices/calendar/facade.js (GoogleCalendarAdapter export)
 *
...
module.exports = require('../../slices/calendar/facade').GoogleCalendarAdapter;
