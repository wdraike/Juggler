/**
 * Rebuild tasks_v and tasks_with_sync_v to expose weather_humidity_min/max.
 * Migration 20260505004000 added those columns to task_masters but did not
 * update the views, so reads always returned null.
 */
...
exports.down = async function(knex) {
  ...
  // Restore to pre-humidity view shape (matches 20260505002000 up state)
  await knex.raw(`
    CREATE VIEW tasks_v AS
    SELECT
