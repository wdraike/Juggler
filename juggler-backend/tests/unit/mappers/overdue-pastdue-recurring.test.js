...
describe('AC4 (RED) — windowed daily: overdue at WINDOW-CLOSE, not at scheduled slot', () => {
  ...
  // AC2b follow-up resolved by this leg (juggler-sweep-overdue). CASE-1a-preferred is now
  // active and GREEN — the preferred_time_mins ?? slot fallback is implemented in taskMappers.js.
...
describe('CASE 10 — AC2c: time_flex=0 vs time_flex=null DISTINCT boundary (SPEC oracle)', () => {
  ...
  // AC2c follow-up resolved by this leg (juggler-sweep-overdue). CASE-10a is now active and GREEN —
  // the time_flex != null guard in taskMappers.js correctly routes time_flex=0 into the windowed path.
