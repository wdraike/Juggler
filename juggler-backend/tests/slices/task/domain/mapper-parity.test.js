...
function makeTaskRow(overrides) {
  return Object.assign({
    ...
    deadline: null, start_after_at: null, location: '[]', tools: '[]',
...
describe('B6 — rowToTask parity (legacy controller === pure mapper)', () => {
  const cases = {
    ...
    'task with deadline + startAfter': [makeTaskRow({ deadline: '2026-07-01', start_after_at: '2026-06-15' }), TZ, {}],
...
describe('B6 — taskToRow parity (legacy controller === pure mapper)', () => {
  const cases = {
    ...
    'full field set': {
      ...
      startAfter: '2026-06-15', location: ['home'], tools: ['laptop'], when: 'morning',
...
describe('B6 — validation/guard parity (relocated)', () => {
  test('validateTaskInput parity across representative bodies', () => {
    const bodies = [
      ...
      { timeFlex: 999 },
      { deadline: 'not-a-date' },
      { deadline: '2026-01-01', startAfter: '2026-02-01' },
